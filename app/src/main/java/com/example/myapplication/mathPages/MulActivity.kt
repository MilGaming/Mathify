            ...
            Column(
                ...
                if (coolDownOn) {
                    ...
                    LaunchedEffect(key1 = coolDownOn) {
                        ...
                        question =
                            Pair(random.nextInt(1, 6), random.nextInt(1, 6)) // update the question
                        ...
                        //Question scalabililty------------------------------------------------------------
                        question =
                            updateMulQuestion(mmr, random) // update the question according to MMR
